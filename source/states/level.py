...
class Level:
    ...
    def setup_bricks_and_boxes(self):
                ...
                if brick_type == 0:
                    if 'brick_num' in brick_data:
                        ...
                        self.brick_group.add(
                            brick.Brick(x, y, brick_type, None))
                elif brick_type == 1:
        ...
        if 'box' in self.map_data:
            for box_data in self.map_data['box']:
                ...
                if box_type == 1:
                    self.box_group.add(
                        box.Box(x, y, box_type, self.coin_group))
                else:
                    self.box_group.add(
                        box.Box(x, y, box_type, self.powerup_group))
    ...
    def draw(self, surface):
        self.game_ground.blit(
            self.background, self.game_window, self.game_window)
